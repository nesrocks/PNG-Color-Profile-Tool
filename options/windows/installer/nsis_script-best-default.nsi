...
Section "Start Menu Shortcuts"
    ...
    CreateDirectory "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}"
    CreateShortcut "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}\${APP_NAME}.lnk" "$INSTDIR\${EXE_NAME}.exe"
    ;create shortcut for uninstaller always use ${UNINST_EXE} instead of uninstall.exe
    CreateShortcut "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}\uninstall.lnk" "${UNINST_EXE}"
    CreateShortCut "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}\${APP_NAME} License.lnk" "notepad.exe" "$INSTDIR\License.txt"
...
Section UnInstall
        ...
        Delete "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}\${APP_NAME}.lnk"
        Delete "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}\uninstall.lnk"
        Delete "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}\${APP_NAME} License.lnk"
        RmDir "$SMPROGRAMS\${PRODUCT_PUBLISHER}\${APP_NAME}"
